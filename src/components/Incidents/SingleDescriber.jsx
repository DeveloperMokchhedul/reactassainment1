...
function SingleDescriber({text}) {
  return (
    <div className='max-w-[180px] h-[69px]  col-span-6 sm:col-span-3 md:col-span- border-1 rounded-[6px] bg-bgSecondary hover:bg-primary hover:text-white flex items-center '>
